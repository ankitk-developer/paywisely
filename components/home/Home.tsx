...
const Home = () => {
  return (
    <div className="font-nunito">
      <GetStarted />
      <div className=" text-4xl font-extrabold text-main text-center">
        Spend Smarter <br /> Save More
      </div>
      <div className="absolute bottom-8 w-full">
        <div className="flex justify-center">
          <button
            className="w-[80%] border-[1px] font-semibold border-black rounded-full px-4 py-4 text-2xl shadow-2xl text-white"
            style={{
